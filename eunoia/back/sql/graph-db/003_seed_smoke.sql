...
-- Seed nodes and alias
INSERT IGNORE INTO graph_nodes (id, type, title, confidence, status)
VALUES ('n_01TESTSEEDNODE000000000000', 'Person', 'Mel', 0.9, 'promoted'),
       ('n_01TESTSEEDTASK000000000000', 'Task', 'Pici hand analysis', 0.6, 'promoted');

INSERT IGNORE INTO graph_node_aliases (id, node_id, alias, source, weight)
VALUES ('a_01TESTSEEDALIAS00000000000', 'n_01TESTSEEDNODE000000000000', 'Mel', 'seed', 1.0);

INSERT IGNORE INTO graph_edges (id, src_id, dst_id, type, weight)
VALUES ('e_01TESTSEEDEDGE000000000000', 'n_01TESTSEEDNODE000000000000', 'n_01TESTSEEDTASK000000000000', 'assigned_to', 0.8);
